...
public partial class Contexts {
    ...
    public const string IndexableEntity = "IndexableEntity";

    [Entitas.CodeGeneration.Attributes.PostConstructor]
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, string>(
            IndexableEntity,
            game.GetGroup(GameMatcher.IndexableEntity),
            (e, c) => ((IndexableEntityComponent)c).uuid));
    }
}

public static class ContextsExtensions {

    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithIndexableEntity(this GameContext context, string uuid) {
        return ((Entitas.EntityIndex<GameEntity, string>)context.GetEntityIndex(Contexts.IndexableEntity)).GetEntities(uuid);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
